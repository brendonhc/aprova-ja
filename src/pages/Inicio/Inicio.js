  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        <Row className="py-4 mx-5 align-items-center justify-content-center " id="sobre" >
          <div className="col"> <img src={aluno} alt="Imagem ilustrando a plataforma para os alunos" /></div>
        ...
        <Row className="py-4 mx-5 align-items-center justify-content-center " id="sobre" >
          <div className="col"> <img src={instrutor} alt="Imagem ilustrando a plataforma para os Instrutores" /></div>
          <div className="col align-items-center justify-content-center ">
